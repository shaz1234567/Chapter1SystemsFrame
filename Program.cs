...
string[] names2 = new[] { "ERROL", "HANK", "REGNEA", "TEDDY" };
...
int[] oneTwoNumbers = new int[] { 8, 4 };
int[] oneTwoTenNumbers = new int[] { 3, 5, 11 };
